...
const categories = [
  {
    ...
    description:
      "Life, Health, Vehicle, Travel and more — for individuals and families.",
    icon: Users,
  ...
  },
  {
    ...
    description:
      "Business protection, employee benefits, liability, property and operational risks.",
    icon: Building2,
      ...
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="text-center max-w-2xl mx-auto mb-12 lg:mb-16">
          ...
          <p className="text-muted-foreground leading-relaxed">
            Explore Personal and Corporate insurance solutions with expert guidance.
          </p>
        </div>
                ...
                <div className="p-7">
                  ...
                  <div className="mt-7 flex flex-wrap gap-3">
                    ...
                    <Button asChild size="lg" variant="outline">
                      <Link href={`/contact?category=${c.id}`}>
                        Request Quote
                      </Link>
                    </Button>
                  </div>
